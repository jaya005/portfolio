...
const Blog = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get("https://portfolio-rsth.onrender.com/blogs");
...
>
  <img
    src={`https://portfolio-rsth.onrender.com/uploads/${blog.image}`}
    alt={blog.title}
        ...
        >
          {selectedBlog && (
            <>
              ...
              <Modal.Body>
                <img
                  src={`https://portfolio-rsth.onrender.com/uploads/${selectedBlog.image}`}
